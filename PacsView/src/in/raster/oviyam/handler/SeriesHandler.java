 ...
 * </HTML>
 */
public class SeriesHandler extends SimpleTagSupport{
	
	private static Logger log = Logger.getLogger(SeriesHandler.class);
	 ...
	 * @param series String object registers the series.
	 */
	...
	public void doTag()throws JspException,IOException{		
		try{
			/*
			 * in.raster.oviyam.SeriesInfo class used to query(cFind) the series details from
		...
		try {
			/*
			 *  ArrayList contains the SeriesModel of particular Study.
			...
			/*
			 * in.raster.oviyam.ImageInfo class used to query(cFind) the Instance informations of
			...
			{	
				/*
				 * 
				 * InstanceModel object contains the Instance informations.
				 * @see in.raster.oviyam.model.InstanceModel.
				 * 			
				 * Here it gets the first InstanceModel. Because to get the SopInstanceUID of first instance of current series.
				 */				
