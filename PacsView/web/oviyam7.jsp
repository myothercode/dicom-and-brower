...
<%@ taglib prefix="ser" uri="/WEB-INF/tags/SeriesInfo.tld"%>
...
<div id="pageHeader">
<button id="searchButton" style="display: none;" class="large" onclick="searchButtonClicked();">
</button>
...
<table width="100%">
	<tr>
		...
		<td><a style="display: none" href="http://oviyam.raster.in" target="_blank"><img
...
<script type="text/javascript" language="javascript">
    var patientI123='<%=request.getParameter("PatientID")%>';
    /*var accN123='<%=request.getParameter("accNo")%>';*/
    var accN123='';
    if((patientI123==null||patientI123==''||patientI123=='null')&&(accN123==null||accN123==''||accN123=='null')){
        document.getElementById('searchPane').style.visibility='hidden';
    }
    else{
        ajaxpage('searchTools','SearchPopup.jsp?PatientID='+patientI123+"&accNo="+accN123);
