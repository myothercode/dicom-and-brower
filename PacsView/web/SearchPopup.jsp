...
<table class="searchTable" id="searchTable" width="100%" style="color:#FFFFFF;">
	<tr>
		...
		<td>
			<table class="searchTable" style="display: none">
				<tr>
					<td>Patient ID.</td><td><input type="text" name="patientId" id="patientId" value="<%=request.getParameter("PatientID")%>"></td>
				</tr>
				<tr>
					<td>Patient Name</td><td><input type="text" name="patientName" id="patientName" value=""></td>
				</tr>
				<tr>
					<td>Accession No.</td><td><input type="text" name="accNo" id="accNo" value="<%=request.getParameter("accNo")%>"></td>
				</tr>
